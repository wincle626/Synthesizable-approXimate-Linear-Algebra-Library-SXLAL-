...
#define DIAG 4
#define MAX_ITER 100
#define SOFT_POSIT_PRECISION 3// SoftPosit precision 0:posit32; 1:posit16; 2:posit8; 3:positx
#define TOTALBITS 28

#if SOFT_POSIT_PRECISION==0
posit32_t sp32zero = convertDoubleToP32(0);
posit32_t invL[DIAG][DIAG];
posit32_t invU[DIAG][DIAG];
posit32_t oneminusalpha = sp32zero;
posit32_t lambdadivrho = sp32zero;
posit32_t rho = sp32zero;
posit32_t alpha = sp32zero;
posit32_t lambda = sp32zero;
posit32_t z[DIAG];
posit32_t u[DIAG];
#elif SOFT_POSIT_PRECISION==1
posit16_t sp16zero = convertDoubleToP16(0);
posit16_t invL[DIAG][DIAG];
posit16_t invU[DIAG][DIAG];
posit16_t oneminusalpha = sp16zero;
posit16_t lambdadivrho = sp16zero;
posit16_t rho = sp16zero;
posit16_t alpha = sp16zero;
posit16_t lambda = sp16zero;
posit16_t z[DIAG];
posit16_t u[DIAG];
#elif SOFT_POSIT_PRECISION==2
posit8_t sp8zero = convertDoubleToP8(0);
posit8_t invL[DIAG][DIAG];
posit8_t invU[DIAG][DIAG];
posit8_t oneminusalpha = sp8zero;
posit8_t lambdadivrho = sp8zero;
posit8_t rho = sp8zero;
posit8_t alpha = sp8zero;
posit8_t lambda = sp8zero;
posit8_t z[DIAG];
posit8_t u[DIAG];
#elif SOFT_POSIT_PRECISION==3
posit_2_t spXzero = pX1_to_pX2(convertDoubleToPX1(0,TOTALBITS),TOTALBITS);
posit_2_t invL[DIAG][DIAG];
posit_2_t invU[DIAG][DIAG];
posit_2_t oneminusalpha = spXzero;
posit_2_t lambdadivrho = spXzero;
posit_2_t rho = spXzero;
posit_2_t alpha = spXzero;
posit_2_t lambda = spXzero;
posit_2_t z[DIAG];
posit_2_t u[DIAG];
#endif
